...
#include "K2Node_GetChartDataAssetRow.generated.h"
...
UCLASS()
class STUDIOTHURSDAYCHARTUNCOOKEDONLY_API UK2Node_GetChartDataAssetRow : public UK2Node
{
	...
	UEdGraphPin* GetChartDataAssetPin(const TArray<UEdGraphPin*>* InPinsToSearch=NULL) const;
	/** Get the spawn transform input pin */	
	UEdGraphPin* GetRowKeyPin() const;
	...
	UScriptStruct* GetChartDataAssetRowStructType() const;
...
private:
	...
	bool IsRowKeyContainsRowMap(const UChartDataAsset& ChartDataAsset) const;
