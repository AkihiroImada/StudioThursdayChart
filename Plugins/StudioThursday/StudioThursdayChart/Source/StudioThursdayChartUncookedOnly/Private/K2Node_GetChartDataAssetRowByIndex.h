...
#include "K2Node_GetChartDataAssetRowByIndex.generated.h"
...
UCLASS()
class STUDIOTHURSDAYCHARTUNCOOKEDONLY_API UK2Node_GetChartDataAssetRowByIndex : public UK2Node
{
	...
	UScriptStruct* GetChartDataAssetRowByIndexStructType() const;
...
private:
	...
	bool IsIndexContainsRowMap(const UChartDataAsset& ChartDataAsset) const;
